        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={`/public/${districtSlug}`} className="text-gray-400 hover:text-white text-sm transition-colors">
                  Strategic Dashboard
                </a>
              </li>
              <li>
                <a href={`/dashboard/${districtSlug}`} className="text-gray-400 hover:text-white text-sm transition-colors">
                  Admin Portal
                </a>
              </li>
              <li>
