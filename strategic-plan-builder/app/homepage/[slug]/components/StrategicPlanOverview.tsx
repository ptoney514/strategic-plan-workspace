          ...
          {overviewStats.map((stat, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="h-full border border-gray-200 hover:shadow-md transition-all duration-300 bg-white">
