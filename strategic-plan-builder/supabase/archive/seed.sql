...
VALUES 
    ...
    ('c2eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'STEM Enrollment', 'number', 'total_number', 1250, 2000, 'students', 'near-target', 'bar'),
    ('d0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'K-2 Reading Level', 'percent', 'state_testing', 65, 90, '%', 'off-target', 'line'),
    ('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Digital Library Usage', 'number', 'total_number', 45000, 75000, 'checkouts', 'near-target', 'bar'),
    ('c3eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Student Support Ratio', 'number', 'survey', 250, 150, 'students/counselor', 'off-target', 'bar'),
    ('c4eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Chronic Absenteeism', 'percent', 'percent', 18, 13.5, '%', 'near-target', 'line')
...
VALUES 
    ...
    ('c6eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'IEP Goal Achievement', 'percent', 'percent', 60, 80, '%', 'near-target', 'bar'),
    ('c7eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'ELL Proficiency Growth', 'percent', 'state_testing', 45, 65, '%', 'near-target', 'line'),
    ('c8eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Teacher Retention Rate', 'percent', 'survey', 82, 90, '%', 'near-target', 'bar'),
    ('c9eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'PD Hours per Teacher', 'number', 'total_number', 40, 60, 'hours', 'on-target', 'bar'),
    ('d3eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Students in Intervention', 'number', 'total_number', 2500, 3500, 'students', 'near-target', 'bar')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.spb_metrics (goal_id, name, metric_type, data_source, current_value, target_value, unit, status, chart_type)
VALUES 
    ('caeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Device Coverage', 'percent', 'percent', 85, 100, '%', 'near-target', 'bar'),
    ('cbeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Digital Platform Usage', 'percent', 'percent', 70, 90, '%', 'near-target', 'line'),
    ('cceebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'CS Course Enrollment', 'number', 'total_number', 3200, 5000, 'students', 'on-target', 'bar'),
    ('cdeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Graduation Rate', 'percent', 'state_testing', 89, 95, '%', 'near-target', 'line'),
    ('ceeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'College Enrollment Rate', 'percent', 'percent', 72, 85, '%', 'near-target', 'bar'),
    ('cfeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'CTE Completions', 'number', 'total_number', 1800, 2500, 'students', 'on-target', 'bar'),
    ('d5eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Devices Deployed', 'number', 'total_number', 42000, 48000, 'devices', 'near-target', 'bar'),
    ('d6eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Internet Connectivity', 'percent', 'survey', 78, 95, '%', 'off-target', 'line')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.spb_metrics (goal_id, name, metric_type, data_source, current_value, target_value, unit, status, chart_type)
VALUES 
    ('d8eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'CRT Training Completion', 'percent', 'percent', 45, 100, '%', 'off-target', 'bar'),
    ('d9eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Discipline Disparity Index', 'number', 'total_number', 3.2, 1.0, 'ratio', 'off-target', 'line')
ON CONFLICT DO NOTHING;
...
INSERT INTO public.spb_metrics (goal_id, name, metric_type, data_source, current_value, target_value, unit, status, chart_type)
VALUES 
    ('daeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Test Metric 1', 'percent', 'percent', 50, 75, '%', 'near-target', 'bar'),
    ('dbeebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Test Metric 2', 'number', 'total_number', 100, 200, 'units', 'on-target', 'line'),
    ('dceebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Test Metric 3', 'currency', 'total_number', 50000, 100000, '$', 'off-target', 'bar')
ON CONFLICT DO NOTHING;
